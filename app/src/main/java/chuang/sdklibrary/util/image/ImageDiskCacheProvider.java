...
import chuang.sdklibrary.util.cache.DiskCacheProvider;
import chuang.sdklibrary.util.diskcache.CacheEntry;
import chuang.sdklibrary.util.diskcache.DiskCache;
import chuang.sdklibrary.util.diskcache.lru.SimpleDiskLruCache;
import chuang.sdklibrary.util.image.iface.ImageDownloader;
import chuang.sdklibrary.util.image.impl.SimpleDownloader;
