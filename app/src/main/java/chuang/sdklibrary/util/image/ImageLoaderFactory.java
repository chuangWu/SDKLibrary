package chuang.sdklibrary.util.image;

import android.content.Context;
import android.text.TextUtils;

import chuang.sdklibrary.util.cache.DiskFileUtils;
import chuang.sdklibrary.util.image.iface.ImageDownloader;
import chuang.sdklibrary.util.image.iface.ImageLoadHandler;
import chuang.sdklibrary.util.image.iface.ImageMemoryCache;
import chuang.sdklibrary.util.image.iface.ImageResizer;
import chuang.sdklibrary.util.image.iface.ImageTaskExecutor;
import chuang.sdklibrary.util.image.impl.DefaultImageLoadHandler;
import chuang.sdklibrary.util.image.impl.DefaultImageResizer;
import chuang.sdklibrary.util.image.impl.DefaultImageTaskExecutor;
import chuang.sdklibrary.util.image.impl.DefaultMemoryCache;
