...
import chuang.sdklibrary.util.holder.LazyViewHolderCreator;
import chuang.sdklibrary.util.holder.ViewHolderBase;
...
public abstract class ListViewDataAdapterBase<ItemDataType> extends BaseAdapter {
    ...
    /**
     * @param viewHolderCreator The view holder creator will create a View Holder that extends {@link }
     */
